...
const AddCoffee = () => {
  ...
  const handleaddcoffe =  (e)=>{
    ...
    const newcoffe = {
      name,chef,supplier,category,details,taste,photo
    }
    ...
    return (
        <div>
            ...
            <Link className='font-mainfamily flex items-center gap-2 btn' to={'/'}>Back to home<IoReturnDownBack /> </Link>
            <div className="card mx-auto bg-[#F4F3F0] w-5/12 shrink-0 border ">
           <div className='p-7'>
           <h1 className='text-center text-2xl font-bold'>Add New Coffee</h1>
           <p className='text-center font-thin mt-4'>It is a long established fact that a reader will be distraceted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using Content here.</p>
           </div>
      <form onSubmit={handleaddcoffe} className="card-body">
       ...
       <div className="form-control">
          ...
          <input type="text" name='name' placeholder="Enter new coffee name" className="input input-bordered" required />
        </div>
        <div className="form-control">
          <label className="label">
       ...
       <div className="form-control">
        ...
        <div className="form-control mt-6">
          <button className="btn bg-[#D2B48C] text-[#331A15]">Add Coffee</button>
        </div>
      </form>
    </div>
